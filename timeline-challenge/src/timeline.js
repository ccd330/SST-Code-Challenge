    ...
    return (
        <div>
            ...
            <div style={{textAlign:'center'}}>
                <h2>Event Input</h2>
                <p>Please enter Start and End times in seconds format (ex: 1000, 2800, 4398).</p>
                ...
                <button type="submit" style={{border: '1px solid gray', borderRadius:'5px'}}>Add Event</button>
                </form>
            </div>
        </div>
    );
